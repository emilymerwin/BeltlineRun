...
for f in files:
	...
	slides.append({"media": {"url": f.strip("../"), "credit": "Ben Gray/AJC", "caption": ""}, "date": get_field(exif, "DateTimeOriginal"), "location": {"lat": lat, "lon": lon, "zoom": 15}, "text": {"headline": "", "text": get_field(exif, 'DateTimeOriginal')}})
